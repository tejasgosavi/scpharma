...
public class GridProductLayout2Adapter extends BaseAdapter {
    List<HorizontalProductModel> horizontalProductModelList;

    public GridProductLayout2Adapter(List<HorizontalProductModel> horizontalProductModelList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            productTile.setText(horizontalProductModelList.get(position).getProductTitle());
        }else {
                view =convertView;
        }
        return view;
